...
class VatNumberXlsx(models.AbstractModel):
    ...
    def create_issued_sheet(self, workbook, book, draft_export):
        ...
        if draft_export:
            ...
            next_col += 1
            sheet.write(5, next_col, "Cuenta de Ingreso")
            sheet.set_column(next_col, next_col, 50)
    ...
    def fill_issued_row_data(
        ...
        if draft_export:
            ...
            num_row = row - 1
            sheet.write(num_row, last_column -1, tax_line.tax_id.name)
            sheet.write(num_row, last_column, line.move_id.account_expense_text)
    ...
    def create_received_sheet(self, workbook, book, draft_export):
        ...
        if draft_export:
            ...
            sheet.set_column(next_col, next_col, 50)
            next_col += 1
            sheet.write(5, next_col, "Cuenta de Gasto")
            sheet.set_column(next_col, next_col, 50)
